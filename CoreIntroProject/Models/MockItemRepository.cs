...
namespace CoreIntroProject.Models
{
    public class MockItemRepository: IItemRepository
    {
        ...
        public IEnumerable<Item> AllItems =>
            new List<Item>
            {
                new Item {ItemId = 1, Name="Burton Board", ShortDescription="Cool Burton Board", LongDescription="Super Super Cool Burton Board", Price=120, ImageUrl="~/Images/snowboard.jpg", ImageThumbnailUrl="~/Images/logo.jpg", IsDealOfTheWeek=false, InStock=true, Category = _categoryRepository.AllCategories.ToList()[0]},
